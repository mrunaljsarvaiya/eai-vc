...
class LocalTopDownMapSensor(Sensor):
    ...
    def get_observation(
        ...
        full_map = maps.get_topdown_map(
            self._sim.pathfinder, map_resolution=self.map_resolution, height=agent_y
        )
        ...
        map_h, map_w = full_map.shape  # Height & Width of map
        ...
        local_map = full_map[min_y:max_y, min_x:max_x]
