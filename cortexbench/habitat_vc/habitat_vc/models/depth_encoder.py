...
class DepthEncoder(nn.Module):
    def __init__(self, repr_dim):
        ...
        self.model.load_state_dict(torch.load('/home/pratyaksh/arpl/workspaces/ws_dynamics/Depth-Anything-V2/model_weights/depth_anything_v2_vits.pth', map_location='cpu'))
